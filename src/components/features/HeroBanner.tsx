  ...
  return (
    <section className="relative py-24 px-6 overflow-hidden">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto text-center relative">
        ...
        <h1 className="text-5xl font-black text-foreground mb-4">上質な暮らしを、<br />あなたの手に。</h1>
        <p className="text-zinc-400 max-w-xl mx-auto mb-8">厳選されたアイテムで、毎日をもっと豊かに。</p>
        <Link to="/products" className="inline-flex items-center gap-2 bg-accent-600 hover:bg-accent-500 text-on-accent px-8 py-3.5 rounded-xl font-semibold transition-colors">
