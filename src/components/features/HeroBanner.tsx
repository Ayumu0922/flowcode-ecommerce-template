  ...
  return (
    <section className="relative py-24 px-6 overflow-hidden">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto text-center relative">
        <span className="inline-block px-4 py-1.5 rounded-full bg-rose-500/10 text-rose-400 text-sm font-medium mb-6">春の新作コレクション</span>
        ...
        <Link to="/products" className="inline-flex items-center gap-2 bg-rose-600 hover:bg-rose-500 text-white px-8 py-3.5 rounded-xl font-semibold transition-colors">
